...
if ($change < 0)
    ...
    if(($change - 100) > 0)
        for($i = 1; $i<=$change; $i++){
            if(($change-(100 * $i)) > 0 || ($change-(100 * $i)) == 0 )
            $hundredNote += 1;
            $change -= (100 );
    ...
    if(($change - 50) > 0)
        for($i = 1; $i<=$change; $i++){
            if(($change-(50 * $i)) > 0 || ($change-(50 * $i)) == 0 )
            $fiftyNote += 1;
            $change -= (50 );
    ...
    if(($change - 20) > 0)
        for($i = 1; $i<=$change; $i++){
            if(($change-(20 * $i)) > 0 || ($change-(20 * $i)) == 0 )
            $twentyNote += 1;
            $change -= (20 );
    ...
    if(($change - 10) > 0)
        for($i = 1; $i<=$change; $i++){
            if(($change-(10 * $i)) > 0 || ($change-(10 * $i)) == 0 )
            $tenNote += 1;
            $change -= (10 );
